...
# Run using: 
# !python3 ..//training/dialogsum_bart_tokenizer.py
...
args = Seq2SeqTrainingArguments(
    ...
    push_to_hub=False,
    output_dir = 'dialogsumm-bart/results/',
    logging_dir = 'dialogsumm-bart/results/'
)
...
torch.save(model, 'dialogsumm-bart/models/')
